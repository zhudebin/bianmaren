    ...
    <div class="row items-push">
        ...
        <div class="col-sm-5 text-right hidden-xs">
            <ol class="breadcrumb push-10-t">
                <li>内容管理</li>
                <li><a class="link-effect">添加文章</a></li>
            </ol>
        </div>
    </div>
</div>
    ...
    <div class="block-content table-responsive">
        <form id="inputForm" class="form-horizontal" action="save.html" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-md-4">
                    <div class="form-material">
                        <input class="form-control" type="text" id="author" name="author" disabled required value="[@shiro.user][@shiro.principal/][/@shiro.user]">
                    ...
                    <div>
                        <label>
                            <label class="css-input css-checkbox css-checkbox-success">
                                <input type="checkbox" name="isPublication" value="true" checked><span></span> ${message("Article.isPublication")}
                            </label>
                        </label>
                        <label>
                            <label class="css-input css-checkbox css-checkbox-success">
                                <input type="checkbox" name="isTop" value="true" /><span></span> ${message("Article.isTop")}
                            </label>
                        </label>
                    </div>
                </div>
            ...
            <div class="form-group">
                <div class="col-xs-12 col-md-10">
                    <div class="form-material">
                        <input class="form-control" type="text" id="reprintedUrl" name="reprintedUrl">
            ...
            <div class="form-group">
                <div class="col-xs-12 col-md-4">
                    ...
                    [#list tags as tag]
                        <label class="css-input css-checkbox css-checkbox-success">
                            <input type="checkbox" name="tagIds" value="${tag.id}" /><span></span> ${tag.name}
                        </label>
                    [/#list]
                    </div>
                </div>
            ...
            <div class="form-group">
                <div class="col-xs-12 col-md-10">
                    <textarea id="editor" name="content" class="editor hidden"></textarea>
                    <script id="editorUe" type="text/plain" style="width:100%;min-height:500px;"></script>
                </div>
            </div>
