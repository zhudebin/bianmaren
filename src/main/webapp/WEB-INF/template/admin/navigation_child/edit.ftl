    ...
    <div class="row items-push">
        ...
        <div class="col-sm-5 text-right hidden-xs">
            <ol class="breadcrumb push-10-t">
                <li>运营管理</li>
                <li><a class="link-effect">编辑子导航</a></li>
            </ol>
        </div>
    </div>
</div>
...
<div class="block">
    <div class="block-content table-responsive">
        <form id="inputForm" class="form-horizontal" action="update.html" method="post">
            ...
            <input type="hidden" id="pid" name="pid" value="${navigation.parentNavigation.id}">
            <div class="form-group">
                <div class="col-xs-12 col-md-8">
                    <div class="form-material floating">
                        <input class="form-control" type="text" id="name" name="name" maxlength="200" required value="${navigation.parentNavigation.name}" disabled >
                        <label for="name">父导航</label>
                    </div>
                </div>
            </div>
            <div class="form-group">
