		...
		<div class="row items-push">
			<div class="col-sm-7">
				<h1 class="page-heading">
                    [${navigation.name}] 子导航列表 <small>${message("admin.page.total", page.total)}</small>
	...
	<!-- END Page Header -->
        ...
        <div class="block">
            <form id="listForm" action="list.html" method="post">
                <input type="hidden" id="pid" name="pid" value="${navigation.id}">
                <div class="block-header">
                    <div class="pull-left">
                        <a href="add.html?pid=${navigation.id}" class="btn btn-sm btn-success">
                ...
                <div class="block-content table-responsive remove-padding-t">
                    <table class="table table-bordered" id="listTable">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="edit.html?id=${data.id}&pid=${navigation.id}" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" data-original-title="编辑"><i class="fa fa-pencil"></i></a>
                                </div>
                            </td>
                        </tr>
						[/#list]
