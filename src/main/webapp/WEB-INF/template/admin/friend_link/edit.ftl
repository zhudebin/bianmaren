    ...
    <div class="row items-push">
        ...
        <div class="col-sm-5 text-right hidden-xs">
            <ol class="breadcrumb push-10-t">
                <li>运营管理</li>
                <li><a class="link-effect">编辑友情链接</a></li>
            </ol>
        </div>
    </div>
</div>
...
<div class="block">
    <div class="block-content table-responsive">
        <form id="inputForm" class="form-horizontal" action="update.html" method="post">
            ...
            <div class="form-group">
                <div class="col-xs-12 col-md-4 ">
                    <div class="form-material floating">
                        <input class="form-control" type="text" id="name" name="name"  value="${friendLink.name}" maxlength="200" required >
                ...
                <div class="col-xs-12 col-md-4">
                    <div class="form-material floating">
                        <select id="type" name="type" class="form-control">
                            [#list types as type]
                                <option [#if type == friendLink.type]selected[/#if] value="${type}">${message("FriendLink.Type." + type)}</option>
                            [/#list]
                        </select>
            ...
            <div class="form-group [#if friendLink.type =='text']hidden[/#if]" id="logoBox">
                <div class="col-xs-12 col-md-4">
                    <div class="form-material input-group">
                        <input class="form-control" type="text" id="logo" name="logo" value="${friendLink.logo}">
            ...
            <div class="form-group">
                <div class="col-xs-12 col-md-4">
                    <div class="form-material floating">
                        <input class="form-control" type="text" id="url" name="url" maxlength="200" value="${friendLink.url}">
                        <label for="url">地址</label>
                    </div>
                </div>
                <div class="col-xs-12 col-md-4">
                    <div class="form-material floating">
                        <input class="form-control" type="text" id="order" name="order" maxlength="9" value="${friendLink.order}"  digits="true">
