		...
		<div class="row items-push">
			<div class="col-sm-7">
				<h1 class="page-heading">
                    友情链接列表 <small>${message("admin.page.total", page.total)}</small>
			...
			<div class="col-sm-5 text-right hidden-xs">
				<ol class="breadcrumb push-10-t">
					<li>运营管理</li>
					<li><a class="link-effect">友情链接列表</a></li>
				</ol>
			</div>
		</div>
	</div>
                ...
                <div class="block-content table-responsive remove-padding-t">
                    <table class="table table-bordered" id="listTable">
                        ...
                        <tr>
                            ...
                            <th class="sort" name="logo">LOGO<i class="fa"></i></th>
                            <th class="sort" name="url">地址 <i class="fa"></i></th>
                        ...
                        <tr>
                            ...
                            <td>
                                <span data-toggle="tooltip" data-original-title="${friendLink.createDate?string("yyyy-MM-dd HH:mm:ss")}" >${friendLink.createDate}</span>
                            </td>
                            <td>
                                <div class="btn-group">
                                    <a href="edit.html?id=${friendLink.id}" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" data-original-title="编辑"><i class="fa fa-pencil"></i></a>
                                </div>
                            </td>
                        </tr>
						[/#list]
