    ...
    <div class="row items-push">
        <div class="col-sm-7">
            <h1 class="page-heading">
                日志列表 <small>${message("admin.page.total", page.total)}</small>
        ...
        <div class="col-sm-5 text-right hidden-xs">
            <ol class="breadcrumb push-10-t">
                <li>网站管理</li>
                <li><a class="link-effect">日志列表</a></li>
            </ol>
        </div>
    </div>
</div>
                    ...
                    <div class="input-group input-group-sm">
                        <div class="input-group-btn" id="searchPropertySelect">
                            <select class="form-control input-sm" style="margin-right: -1px;" id="searchPropertyOption">
                                <option [#if page.searchProperty == "operation"]selected[/#if] value="operation">操作</option>
                                <option [#if page.searchProperty == "operator"]selected[/#if] value="operator">操作员</option>
                            </select>
                        </div>
        ...
        <div class="block-content table-responsive remove-padding-t">
            <table class="table table-bordered" id="listTable">
                ...
                <tr>
                    ...
                    <th class="sort" name="operation">操作 <i class="fa"></i></th>
                    <th class="sort" name="operator">操作员 <i class="fa"></i></th>
                    <th class="sort" name="ip">IP <i class="fa"></i></th>
                    <th class="sort" name="content">内容 <i class="fa"></i></th>
                ...
                <tr>
                    ...
                    <td>
                        <span title="${data.createDate?string("yyyy-MM-dd HH:mm:ss")}">${data.createDate}</span>
                    </td>
                    <td>
                        <div class="btn-group">
                            <a href="view.html?id=${data.id}" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="" data-original-title="详情"><i class="fa fa-eye"></i></a>
                        </div>
                    </td>
                </tr>
				[/#list]
