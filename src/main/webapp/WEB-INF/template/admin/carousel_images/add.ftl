        ...
        <div class="row items-push">
            ...
            <div class="col-sm-5 text-right hidden-xs">
                <ol class="breadcrumb push-10-t">
                    <li>运营管理</li>
                    <li><a class="link-effect">添加轮播图</a></li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="block-content table-responsive">
            <form id="inputForm" class="form-horizontal" action="save.html" method="post">
                ...
                <div class="form-group">
                    <div class="col-xs-12 col-md-4">
                        <div class="form-material floating">
                            <input class="form-control" type="text" id="order" name="order" maxlength="9"  digits="true">
                ...
                <div class="form-group">
                    <div class="col-xs-12 col-md-4">
                        <div class="form-material floating">
                            <input class="form-control" type="text" id="url" name="url" maxlength="200">
                ...
                <div class="form-group">
                    <div class="col-xs-12 col-md-4">
                        <label class="css-input switch switch-sm switch-success">
                            是否启用    <input type="checkbox" id="is_enable" name="is_enable" checked><span></span>
                        </label>
                    </div>
                </div>
                <div class="form-group">
