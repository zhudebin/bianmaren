		...
		<div class="row items-push">
			<div class="col-sm-7">
				<h1 class="page-heading">
                    导航列表 <small>${message("admin.page.total", page.total)}</small>
			...
			<div class="col-sm-5 text-right hidden-xs">
				<ol class="breadcrumb push-10-t">
					<li>运营管理</li>
					<li><a class="link-effect">导航列表</a></li>
				</ol>
			</div>
		</div>
	</div>
                ...
                <div class="block-content table-responsive remove-padding-t">
                    <table class="table table-bordered" id="listTable">
                        ...
                        <tr>
                            ...
                            <th class="sort" name="url">url<i class="fa"></i></th>
                            <th>子导航<i class="fa"></i></th>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="label label-default" href="../navigation_child/list.html?pid=${data.id}" ><i class="fa fa-code-fork"></i> [ ${data.navigationChildList?size} ] </a>
                            </td>
                            <td>
                                [#if data.is_enable]
                            ...
                            <td>
                              [#--  <span title="${data.createDate?string("yyyy-MM-dd HH:mm:ss")}">${data.createDate}</span>--]
                                <span data-toggle="tooltip" data-original-title="${data.createDate?string("yyyy-MM-dd HH:mm:ss")}" >${data.createDate}</span>
                            </td>
                            <td>
                                <div class="btn-group">
                                    <a href="edit.html?id=${data.id}" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" data-original-title="编辑"><i class="fa fa-pencil"></i></a>
                                </div>
                            </td>
                        </tr>
						[/#list]
