    ...
    <div id="side-overlay-scroll">
        ...
        <div class="side-header side-content">
            ...
            <button class="btn btn-default pull-right" type="button" data-toggle="layout" data-action="side_overlay_close">
                ...
                <span>
                    <img class="img-avatar img-avatar32" src="${base}/assets/img/avatars/avatar10.jpg" alt="">
                                ...
                                <ul class="nav-users remove-margin-b">
                                    <li>
                                        <a href="base_pages_profile.html">
                                            <img class="img-avatar" src="${base}/assets/img/avatars/avatar7.jpg" alt="">
                                    ...
                                    <li>
                                        <a href="base_pages_profile.html">
                                            <img class="img-avatar" src="${base}/assets/img/avatars/avatar13.jpg" alt="">
                                    ...
                                    <li>
                                        <a href="base_pages_profile.html">
                                            <img class="img-avatar" src="${base}/assets/img/avatars/avatar3.jpg" alt="">
                                    ...
                                    <li>
                                        <a href="base_pages_profile.html">
                                            <img class="img-avatar" src="${base}/assets/img/avatars/avatar2.jpg" alt="">
                                    ...
                                    <li>
                                        <a href="base_pages_profile.html">
                                            <img class="img-avatar" src="${base}/assets/img/avatars/avatar16.jpg" alt="">
