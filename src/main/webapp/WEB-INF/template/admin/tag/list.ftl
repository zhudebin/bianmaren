    ...
    <div class="row items-push">
        <div class="col-sm-7">
            <h1 class="page-heading">
               标签列表 <small>${message("admin.page.total", page.total)}</small>
        ...
        <div class="col-sm-5 text-right hidden-xs">
            <ol class="breadcrumb push-10-t">
                <li>内容管理</li>
                <li><a class="link-effect">标签列表</a></li>
            </ol>
        </div>
    </div>
</div>
                    ...
                    <div class="input-group input-group-sm">
                        <div class="input-group-btn" id="searchPropertySelect">
                            <select class="form-control input-sm" style="margin-right: -1px;" id="searchPropertyOption">
                                <option [#if page.searchProperty == "title"]selected[/#if] value="title">标签名称</option>
                            </select>
                        </div>
        ...
        <div class="block-content table-responsive remove-padding-t">
            <table class="table table-bordered" id="listTable">
                ...
                <tr>
                    ...
                    <th class="sort" name="name">标签名称 <i class="fa"></i></th>
                    <th class="sort" name="type">标签类型 <i class="fa"></i></th>
                    <th>标签图标</th>
                    <th>排序</th>
                    <th>创建时间</th>
                    <th>操作</th>
                ...
                <tbody>
                    [#list page.content as tag]
                        <tr>
                            ...
                            <td>
                                <span data-toggle="tooltip" data-original-title="${tag.createDate?string("yyyy-MM-dd HH:mm:ss")}">${tag.createDate}</span>
                            </td>
                            <td>
                                <div class="btn-group">
                                    <a href="edit.html?id=${tag.id}" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="" data-original-title="编辑"><i class="fa fa-pencil"></i></a>
                                </div>
                            </td>
                        </tr>
                    [/#list]
