...
public class Article extends BaseEntity {
	...
	/** 内容分页长度 */
	private static final int PAGE_CONTENT_LENGTH = 2600;
	...
	static {
		try {
			staticPath = "/article/content/${createDate?string('yyyyMM')}/${articleId}/${pageNumber!1}.htm";
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
