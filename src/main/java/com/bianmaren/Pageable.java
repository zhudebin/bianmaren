...
public class Pageable implements Serializable {
	...
	private static final int DEFAULT_PAGE_NUMBER = 1;//默认第一页

	private static final int DEFAULT_PAGE_SIZE = 20;//默认每页20条

	private static final int MAX_PAGE_SIZE = 1000;//每页最多1000条
